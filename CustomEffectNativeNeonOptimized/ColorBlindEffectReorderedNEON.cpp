// ColorBlindEffectReorderedNEON.cpp
#include "pch.h"
#include <wrl.h>
#include <robuffer.h>
#include "ColorBlindEffectReorderedNEON.h"
#include <ppltasks.h>
#include "Helpers.h"
#include <arm_neon.h>
...
ColorBlindEffectReorderedNEON::ColorBlindEffectReorderedNEON()
{
}

Windows::Foundation::IAsyncAction^ ColorBlindEffectReorderedNEON::LoadAsync()
{
...
void ColorBlindEffectReorderedNEON::Process(Windows::Foundation::Rect rect)
{
...
Windows::Storage::Streams::IBuffer^ ColorBlindEffectReorderedNEON::ProvideSourceBuffer(Windows::Foundation::Size imageSize)
{
...
Windows::Storage::Streams::IBuffer^ ColorBlindEffectReorderedNEON::ProvideTargetBuffer(Windows::Foundation::Size imageSize)
{
	unsigned int size = (unsigned int)(4 * imageSize.Height * imageSize.Width);
