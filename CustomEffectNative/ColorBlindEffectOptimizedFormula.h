// ColorblindEffectOptimizedFormula.h
#pragma once

namespace CustomEffectNative
{
	public ref class ColorblindEffectOptimizedFormula sealed : public Nokia::Graphics::Imaging::ICustomEffect
    {
    public:
        ColorblindEffectOptimizedFormula();
